...
const char* model = "models/output_graph.pbmm";

const char* alphabet = "models/alphabet.txt";

const char* lm = "models/lm.binary";

const char* trie = "models/trie";
